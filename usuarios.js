...
module.exports = {developers, marketing, QAs, ventas, usersData}

// function findSpecialty(x) {
//     const specialty = usersData.filter((user) => user.specialty == x);
//     return specialty
// }

// module.exports = {findSpecialty, usersData}
